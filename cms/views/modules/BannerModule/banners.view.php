                ...
                <div class="builder-list_item__item_content">
                    ...
                    <div class="uk-grid">
                        <div class="uk-width-3-5">
                            <span class='js_cms-item_title uk-text-muted' namiText="title">
                                Название
                            </span>
                        </div>
        ...
        <form class="uk-form uk-form-horizontal">
            ...
            <div class="uk-form-row">
                <label class="uk-form-label">
                    Отображать на баннерных местах
                </label>

                <div class="uk-form-controls">
                    <select data-placeholder="выбрать..." multiple="multiple" name="places_ids" class="js-cms_chosen_widget">
                        <? foreach ($places as $place): ?>
                            <option value="<?= $place->id ?>">
                                <?= $place->title ?> (<?= $place->width ?>&times;<?= $place->heigth ?>)
                            </option>
                        <? endforeach; ?>
                    </select>

                    <span class="uk-text-primary uk-text-small">
                        Размер места указан в пикселях. Баннер должен соответствовать размеру места.
                    </span>
                </div>
            </div>
