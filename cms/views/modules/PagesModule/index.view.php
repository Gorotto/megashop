                    ...
                    <div class="uk-text-right">
                        <div class="uk-button-group">
                            ...
                            <? if ($show_edit_interface): ?>
                                ...
                                <button
                                    class="uk-button js_cms-switcher_item"
                                    title="Отображать в меню"
                                    namiIconTrue="star"
                                    namiIconFalse="star-o"
                                    namiField="menu">
                                    <i class="uk-icon-star<?= $item->menu ? "" : "-o" ?>"></i>
                                </button>

                                <button title="Отображать на сайте" class="uk-button js_cms-enabled_item" namiField="enabled"><i class="uk-icon-eye<?= $item->enabled ? "" : "-slash" ?>"></i></button>
...
<div class="uk-grid uk-margin-small-bottom">
    ...
    <?php if (CmsApplication::is_develop_mode()): ?>
        <div class="uk-width-1-2 uk-text-right">
            <a href="<?= $this->uri ?>/page_types">Типы страниц</a>
        </div>
    <?php endif; ?>
</div>
...
<div class="uk-panel uk-panel-box" style="margin-top: 200px;">
    <div class="uk-panel-badge uk-badge">
        <i class="uk-icon-info"></i>
    </div>

    <p>
        <i class="uk-icon-eye"></i> — Отображать страницу на сайте
        <br>
        <i class="uk-icon-star"></i> — Отображать страницу в главном меню сайта
    </p>
</div>
