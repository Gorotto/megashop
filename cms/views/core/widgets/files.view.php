<div class="uk-form-row">
    ...
    <div class="uk-form-controls js-cms_filesupload__container">
        <input type="hidden" filesupload="yes" name="<?= $this->name ?>" />

        <div class="uk-width-1-1 uk-margin-small-bottom js-cms_filesupload__files">

            <div class="js-cms_filesupload__file_block js-cms_filesupload__file_block-template" style="display: none;">
                <div class="builder-files_list__item uk-panel uk-panel-box uk-panel-hover uk-clearfix">
                    ...
                    <div class="uk-float-left">
                        <div class="uk-nestable-handle uk-nestable-handle__files uk-margin-right"></div>
