                    ...
                    delete this.imageElement
                            ...
                            {type: "hbox", children: [{id: "basic", type: "vbox", children: [{type: "hbox", requiredContent: "img{width,height}", widths: ["50%", "50%"], children: [{type: "vbox", padding: 1, children: [{type: "text", width: "45px", id: "txtWidth", label: c.lang.common.width, onKeyUp: w, onChange: function() {
                                                        ...
                                                        type: "html", style: "margin-top:30px;width:40px;height:40px;", onLoad: function() {
                                                            ...
                                                            c.lang.image.resetSize + '" class="cke_btn_reset" id="' + u + '" role="button"><span class="cke_label">' + c.lang.image.resetSize + "</span></a></div>"}]}, {type: "vbox", padding: 1, children: [
                                                    /*  
                                                     * контроллы для установления рамки для фотки, отспуов, выравнивания
                                                     * выпиливаем это
                                                     *     
