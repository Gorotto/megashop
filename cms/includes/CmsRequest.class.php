...
class CmsRequest {
    ...
    function __construct($uri = null) {
        ...
        $script_names = Meta::getUriPathNames(Meta::getUriPath($_SERVER['SCRIPT_NAME']));
        ...
        if (array_key_exists(0, $names) && preg_match('/^[A-Z]/', $names[0]) && class_exists($names[0]) && is_subclass_of($names[0], 'NamiModel')) {
